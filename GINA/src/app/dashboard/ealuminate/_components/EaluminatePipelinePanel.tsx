...
const STEP_ICONS = [
  ...
  <svg key="user" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
    <circle cx="12" cy="7" r="4" />
  </svg>,
  /* 2 — Keyword preparation: key */
  <svg key="key" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="7.5" cy="15.5" r="5.5" />
    <path d="M21 2l-9.6 9.6" />
    <path d="M15.5 7.5l3 3L22 7l-3-3" />
  </svg>,
  /* 3 — Scan and classification: database */
  <svg key="db" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <ellipse cx="12" cy="5" rx="9" ry="3" />
    <path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3" />
    <path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5" />
  </svg>,
  /* 4 — Brief ready: file-text */
  <svg key="file" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "clamp(0.75rem, 1.5vw, 1rem)" }}>
        {steps.map((step, i) => {
          ...
          const iconColor = isCompleted ? "#48D4B8" : isActive ? "#4479DA" : "#94a3b8";

          return (
            <div
              key={step.n}
              style={{ display: "flex", gap: "clamp(0.5rem, 1vw, 0.75rem)", alignItems: "flex-start" }}
            >
              {/* Number circle */}
              <div
                style={{
      ...
      >
        <div
          style={{
            ...
            height: 8,
            borderRadius: "50%",
            backgroundColor: pipelineStep >= 5 ? "#4CAF50" : pipelineStep > 0 ? "#4479DA" : "#4CAF50",
            flexShrink: 0,
          }}
        />
        <span style={{ fontSize: "clamp(0.6875rem, 1.25vw, 0.8125rem)", color: "#64748b", fontWeight: 500 }}>
          {pipelineStep === 0
            ? "Pipeline ready"
            : pipelineStep >= 5
              ? "Scan complete"
