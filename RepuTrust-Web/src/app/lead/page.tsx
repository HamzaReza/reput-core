    ...
    >
      ...
      <main style={{ flex: 1, paddingTop: "2rem", paddingBottom: "3rem" }}>
        ...
        >
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <div
                    title="Terms that might appear alongside the name in negative content, e.g. fraud, scam, lawsuit"
                    style={{
                      cursor: "help",
                      color: "var(--color-muted, #64748b)",
                      display: "flex",
          ...
          {/* ── Results ── */}
          <div
            className={`animate-scale-in${!loading && !result ? " glass glow-border" : loading || result ? " glass glow-border" : ""}`}
            style={{
              borderRadius: "0.875rem",
              padding: "2.5rem 2rem",
              textAlign: "center",
              ...
              flexDirection: "column",
              alignItems: "center",
              justifyContent: result ? "flex-start" : "flex-start",
            }}
          >
            {/* Loading */}
            {loading && (
              ...
              >
                ...
                {keywords.length > 0 && (
                  ...
                  >
                    ...
                    >
                      {(showAllKeywords ? keywords : keywords.slice(0, 3)).map(
                        (kw) => (
                          <span
                            key={kw}
                            style={{
