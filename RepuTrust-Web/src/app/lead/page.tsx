...
export default function LeadPage() {
  ...
  const handleSubmit = async (e: React.SyntheticEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (!firstName.trim() || !lastName.trim() || !country || !description.trim() || keywords.length === 0) {
            ...
            >
              ...
              <div>
                    ...
                    {keywords.map((kw) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          style={{ background: "none", border: "none", cursor: "pointer", color: "#4479DA", padding: 0, lineHeight: 1, fontSize: "1rem" }}
                        >
                          ×
                        </button>
                      </span>
                ...
                <p style={{ margin: "0.375rem 0 0", fontSize: "0.75rem", color: "#94a3b8" }}>
                  At least one keyword is required to run the scan
                </p>
              </div>
